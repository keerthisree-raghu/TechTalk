...
from techtalk import app, db, bcrypt, mail
from techtalk.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
